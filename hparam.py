...
tf.flags.DEFINE_integer('max_response_length', 30,'the max response length')
...
tf.flags.DEFINE_integer('num_epochs', 1, 'the number of epochs')
tf.flags.DEFINE_integer('eval_step', 3000, 'eval every n steps')
...
def create_hparam():
    return HParams(
        ...
        max_response_length=FLAGS.max_response_length,
